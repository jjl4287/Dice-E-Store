...
public class UserController {
     ...
     * 
     * @return ResponseEntity with User and HTTP status of OK if log in was
     *         successful
     *         <br>
     *         ResponseEntity with HTTP status of NOT_FOUND if username or password
     *         is incorrect
     *         <br>
     *         ResponseEntity with HTTP status of INTERNAL_SERVER_ERROR otherwise
     */
     ...
     * 
     * @return ResponseEntity with HTTP status of Accepted if the user successfully
     *         logged out
     *         <br>
     ...
     * 
     * @return ResponseEntity with current User and HTTP status of OK if there is a
     *         user logged in
     *         <br>
